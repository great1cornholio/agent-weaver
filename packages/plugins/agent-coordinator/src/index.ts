...
const COORDINATOR_INSTRUCTION =
  "You are the coordinator agent. Return a JSON subtask plan with explicit dependencies.";
  ...
  return {
    ...
    getLaunchCommand(config: AgentLaunchConfig): string {
      ...
      if (config.systemPromptFile) {
        ...
        parts.push("--system-prompt", shellEscape(COORDINATOR_INSTRUCTION));
      }
